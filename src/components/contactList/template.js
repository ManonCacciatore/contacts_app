...
return `
  <div class="w-full bg-white rounded-lg shadow-lg flex flex-wrap overflow-hidden">
    ...
    <aside class="w-1/3 bg-gray-200 p-6 pb-12">
      ...
      <button class="new-contact w-full bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-md">
        Add
      </button>
    </aside>
    ...
    <section class="w-2/3 p-6">
      <div class="flex justify-between items-center mb-4">
        ...
        <p class="text-gray-600 mb-4">
          Contacts Count : <span class="contact-count font-bold"></span>
        </p>
      </div>
